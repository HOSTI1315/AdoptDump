--// ReplicatedStorage.ClientModules.Game.PetEntities.PetPerformancesFolder.Emotes.SickPerformance (ModuleScript)
    ...
    ["init_performance"] = function(_, _)
        local v4 = {
            ["modifiers"] = {
                ...
                ["eyes_id"] = "dizzy_eyes",
                ["accessory_ids"] = { "thermometer", "icepack" }
            },
            ["priorities"] = {
                ["idle_anim_speed"] = v_u_2.Lower,
                ["eyes_id"] = v_u_2.Lower,
                ["accessory_ids"] = v_u_2.Lower
            }
        }
        return v4
    end,
    ["step"] = function(p5, _, _)
        if not p5.ailments.sick then
