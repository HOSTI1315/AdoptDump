--// ReplicatedStorage.ClientModules.Game.PetEntities.PetReactions.CompletedSickAilmentReaction (ModuleScript)
...
local v_u_15 = {
    ...
    ["calculate_score"] = function(_, p10)
        if p10.pet_command_type == v_u_2.CompleteAilment and p10.options.ailment_id == "sick" then
