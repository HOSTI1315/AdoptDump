--// ReplicatedStorage.ClientModules.Game.PetEntities.PetReactions.IceDimensionPetReaction (ModuleScript)
...
local v_u_24 = {
    ["name"] = script.Name,
    ["trigger_stimuli"] = { v4.IceDimensionPet },
