--// ReplicatedStorage.ClientModules.Game.EcoPinBoard (ModuleScript)
...
local v9 = {}
local v_u_10 = {
    ["eco_white_spider_web_badge"] = "EcoWhiteSpiderWebBadge",
    ["eco_blue_recycling_bin_badge"] = "EcoBlueRecyclingBinBadge",
    ["eco_green_vine_badge"] = "EcoGreenVineBadge"
}
local v_u_11 = {
    ["eco_white_spider_web_badge"] = Vector3.new(0, -1, 0),
    ["eco_blue_recycling_bin_badge"] = Vector3.new(0, 0, 1),
    ["eco_green_vine_badge"] = Vector3.new(0, -1, 0)
}
...
function v9.start(p16, p_u_17)
    ...
    local function v_u_37()
        local v23 = v_u_6.get("eco_pin_last_taken_time")
        local v24 = v_u_6.get("eco_pin_last_taken_kind")
        local v25 = os.time()
        local v26 = v_u_7.time_between_eco_pin_awards - (v25 - v23)
        if v26 <= 0 then
        ...
        local v43 = v_u_2:register({
            ...
            ["on_selected"] = function()
                if not v_u_38 then
                    ...
                    }) == "Yes" and v_u_5.get("EventAPI/TakeEcoPin"):InvokeServer(p_u_40) then
                        v_u_37()
                        v_u_15(p_u_39)
