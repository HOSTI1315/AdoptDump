...
v_u_6.disconnect = v_u_6.Disconnect
...
v_u_14.connect = v_u_14.Connect
v_u_14.wait = v_u_14.Wait
v_u_14.fire = v_u_14.Fire
v_u_14.Destroy = v_u_14.DisconnectAll
v_u_14.destroy = v_u_14.DisconnectAll
function v_u_14.init() end
function v_u_14.is(p25)
    local v26
    if typeof(p25) == "table" then
        v26 = getmetatable(p25) == v_u_14
    else
        v26 = false
    end
    return v26
end
function v_u_14.isConnection(p27)
    local v28
    if typeof(p27) == "table" then
        v28 = getmetatable(p27) == v_u_6
    else
        v28 = false
    end
    return v28
