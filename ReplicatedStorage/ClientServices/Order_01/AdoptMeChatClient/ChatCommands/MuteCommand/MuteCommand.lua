--// ReplicatedStorage.ClientServices.Order_01.AdoptMeChatClient.ChatCommands.MuteCommand (ModuleScript)
...
function v_u_4.init(_)
    local v11 = v_u_3:WaitForChild("TextChatCommands"):WaitForChild("RBXMuteCommand")
    v11.Enabled = not v_u_4.Enabled
    if v11.Enabled then
        v11.Triggered:Connect(function(_, p12)
            v_u_9(p12, "roblox-default")
        end)
    end
end
return v_u_4